...
var fetchNavigation = function fetchNavigation(dispatch) {
  debugger;
  return function (dispatch) {
    return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_2___default()("".concat(process.env, "pages/navigation")).then(function (res) {
      return res.json();
    }).then(function (data) {
      return dispatch({
...
//# sourceMappingURL=_app.js.6ee57d7a0a1c2d262c22.hot-update.js.map