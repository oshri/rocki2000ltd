...
var fetchNavigation = function fetchNavigation(dispatch) {
  debugger;
  return function (dispatch) {
    return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_2___default()("".concat(process.env.API_URL, "pages/navigation")).then(function (res) {
      return res.json();
    }).then(function (data) {
      return dispatch({
...
//# sourceMappingURL=index.js.529d5c7d0bc1f6767407.hot-update.js.map