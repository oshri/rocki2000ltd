...
function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return (// <header id="navbar" className={`Header ` + this.state.navClass}>
        // 	<article>
        // 		<Logo/>
        // 		<Menu />
        // 	</article>
        // </header>
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(material_ui_AppBar__WEBPACK_IMPORTED_MODULE_3___default.a, null)
      );
    }
  }]);
...
//# sourceMappingURL=index.js.a8e23e70d7cd8cf42feb.hot-update.js.map