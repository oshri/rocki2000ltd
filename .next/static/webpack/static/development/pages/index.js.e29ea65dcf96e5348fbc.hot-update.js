...
var fetchNavigation = function fetchNavigation(dispatch) {
  debugger;
  return function (dispatch) {
    return isomorphic_fetch__WEBPACK_IMPORTED_MODULE_2___default()("api/pages/navigation").then(function (res) {
      return res.json();
    }).then(function (data) {
      return dispatch({
...
//# sourceMappingURL=index.js.e29ea65dcf96e5348fbc.hot-update.js.map